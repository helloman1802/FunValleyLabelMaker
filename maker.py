...
def user_input():
    ...
    if fun_sku_yes_no.upper() == "YES" or fun_sku_yes_no.upper() == "Y":
        ...
        # Check if the generated sku is unique to the product.
        # If the product is not unique, the program will create another one until it is unique.
        # It checks if the Google Sheet currently has the generated sku.
        # If the sku is unique the worksheet will through an error and break the loop.
        while True:
            ...
            try:
                ...
                print("Unique SKU")
                break
        # Product name, price, label type, size, etc. that will be incerted into the second row of the Google Sheet
        product_name  = input("What is the product name: ")

        product_price = input("Unchanged product price: ")
        product_price = rounder(float(product_price))


        while True:
            product_size_yes_no = input("Size; Yes or No: ")
            if product_size_yes_no.upper() == "YES" or product_size_yes_no.upper() == "Y":
                product_size = input("What's the size: ")
                break
            elif product_size_yes_no.upper() == "NO" or product_size_yes_no.upper() == "N":
                product_size = None
                break
            else:
                print("Not valid")
        ...
        while True:
            product_color_yes_no = input("Color; Yes or No: ")
            if product_color_yes_no.upper() == "YES" or product_color_yes_no.upper() == "Y":
                product_color = input("What's the color: ")
                break
            elif product_color_yes_no.upper() == "NO" or product_color_yes_no.upper() == "N":
                product_color = None
                break
            else:
                print("Not valid")
        ...
        while True:
            square_or_circle = input("Square or Cirlce: ")
            if square_or_circle.upper == "SQUARE" or square_or_circle.upper() == "S" or square_or_circle == 1:
                square_or_circle = 1
                break
            elif square_or_circle.upper() == "CIRCLE" or square_or_circle.upper() == "C" or square_or_circle == 0:
                square_or_circle = 0
                break
            else:
                print("Not valid")

        vendorSKU     = input("Vendor SKU: ")
        vendorInvoice = input("Vendor Invoice Number: ")
        vendorName    = input("Vendor Name: ")
        quantity      = input("Product Quantity: ")


        worksheet.insert_row([fun_sku_number, product_name, product_color, product_size, product_price, None, vendorSKU, vendorInvoice, vendorName, square_or_circle, quantity], index=2)


        print_labels = input("Print the labels; Yes or No: ")
        if print_labels.upper() == "YES" or print_labels.upper() == "Y":
            while True:
                if square_or_circle == 0:
                    ...
                    price       = worksheet.cell(2, 5).value
                    discription = worksheet.cell(2, 2).value
                    size        = worksheet.cell(2, 4).value
                    color       = worksheet.cell(2, 3).value
                    while True:
                        file_name = "qrcode%d.png" % (n)
                        QR = qr.create(fun_sku_number)
                        QR.png(file_name, scale=1)
